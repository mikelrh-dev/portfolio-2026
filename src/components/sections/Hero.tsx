...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto flex-1 w-full flex flex-col">
        {/* Section indicator */}
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full h-[500px] lg:h-[600px] overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center scale-[0.65] lg:scale-[0.75] origin-center">
              <SplineScene
